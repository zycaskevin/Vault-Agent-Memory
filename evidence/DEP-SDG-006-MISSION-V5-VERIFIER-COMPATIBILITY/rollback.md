...
target: SDG-006 GitHub merge commit resolved from the exact agent/sdg006-mission-v5-verifier-compatibility-v2 PR branch and mergeCommit oid
command: git revert --no-edit -m 1 "$(gh pr view agent/sdg006-mission-v5-verifier-compatibility-v2 --repo zycaskevin/Vault-Agent-Memory --json mergeCommit --jq .mergeCommit.oid)"
