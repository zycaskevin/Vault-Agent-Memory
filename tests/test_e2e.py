...
kid3 = db.add_knowledge(title="agent runtime delegate 陷阱", content_raw="delegate_task fallback 鏈全額度用完時三連敗。解法：指定 model 或 acp_command。", layer="L2", category="prevention", tags="agent-runtime,delegate,fallback", source="skill")
