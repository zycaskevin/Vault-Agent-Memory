...
def test_mission_v5_ci_routes_candidate_and_active_controls_without_skips():
    ...
    assert "Run candidate Mission V5 identity controls" not in test_job
    assert "--phase candidate" not in test_job
    assert "Run active Mission V5 identity controls" not in test_job
    assert "--phase active" not in test_job
