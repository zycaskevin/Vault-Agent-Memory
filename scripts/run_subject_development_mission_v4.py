...
try:
    from scripts import run_subject_task_authorization_v3 as legacy
except ImportError:  # pragma: no cover - direct script execution
    try:
        import run_subject_task_authorization_v3 as legacy
    except Exception:
        if __name__ == "__main__":
            sys.stderr.write("SUBJECT_DEVELOPMENT_MISSION_V4_ERROR\n")
...
SCHEMA_PATH = "specs/subject-distillation/development-mission-v4.schema.json"
SCOPE_REGISTRY_PATH = "specs/subject-distillation/task-scope-manifest-v4.json"
MISSION_PROOF_PATH = "specs/subject-distillation/task-authorizations/MISSION-T004-T033.json"
REVOCATION_PATH = "specs/subject-distillation/development-missions/T004-T033.revocation.json"
REVOCATION_PENDING_PATH = (
    "specs/subject-distillation/.development-mission-revocation.pending"
)
...
BRIDGE_BASE = "f7aff39fecbc2fce7d612f396237afb0e094e460"
...
DECISION_ID = "SD-TASK-AUTH-V4-MISSION"
...
DENY_TEXT = "SUBJECT_DEVELOPMENT_MISSION_V4_DENY\n"
ERROR_TEXT = "SUBJECT_DEVELOPMENT_MISSION_V4_ERROR\n"
...
def load_contract(
    ...
    if (
        ...
        or value["artifact_kind"] != "subject-development-mission-v4-contract"
        ...
        != "exact-current-origin-main-after-reviewed-v4-bridge-merge"
        or value["canonicalization"]
        != {
            "digest": "sha256",
            "domain_separator": "vault-subject-development-mission-v4",
        ...
        != {
            ...
            "owner_decision_ref": "owner-message:SD-TASK-AUTH-V4-MISSION",
        }
    ):
        raise Denied
...
def load_registry(
    ...
    *,
    ...
    if (
        ...
        or raw != canonical(value)
        or value["schema_version"] != 4
        or value["artifact_kind"] != "subject-development-mission-v4-scope-registry"
...
def _validate_registry_entry(entry: Any, tasks_raw: bytes) -> None:
    ...
    expected_control_api = (
        "scripts.validate_subject_development_mission_v4:validate_t033_action"
...
def check_repository_identity(repo_root: Path) -> None:
    if _git(repo_root, "remote", "get-url", "origin").strip().decode() not in {
...
def _proof_from_proposal(
    ...
    proof = {
        "schema_version": 4,
        "artifact_kind": "subject-development-mission-v4-proof",
        "status": "PASS",
...
def derive_task_authorization(
    ...
    *,
    ...
    value = {
        "schema_version": 4,
        "artifact_kind": "subject-task-authorization-v4",
        "status": "PASS",
...
def _verify_confirmed(_values: dict[str, str], _runtime: Runtime) -> bytes:
    ...
    with legacy.v1._authorization_lock(
        state.repo_root, "subject-development-mission-v4", base, v1_runtime
    ) as audit_lock:
