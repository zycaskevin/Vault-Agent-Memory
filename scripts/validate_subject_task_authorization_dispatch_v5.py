#!/usr/bin/env python3
"""Version-dispatch Subject authorization through Development Mission v5."""
...
try:
    ...
    if __name__ == "__main__":
        sys.stderr.write("SUBJECT_TASK_AUTHORIZATION_DISPATCH_V5_ERROR\n")
        raise SystemExit(3) from None
    raise


Denied = mission.Denied
DENY_TEXT = "SUBJECT_TASK_AUTHORIZATION_DISPATCH_V5_DENY\n"
ERROR_TEXT = "SUBJECT_TASK_AUTHORIZATION_DISPATCH_V5_ERROR\n"
