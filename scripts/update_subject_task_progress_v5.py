...
try:
    ...
    writer = _load_sibling_dependency(
    ...
    if __name__ == "__main__":
        sys.stderr.write("SUBJECT_TASK_PROGRESS_V5_ERROR\n")
        raise SystemExit(3) from None
    raise


Denied = mission.Denied
DENY_TEXT = "SUBJECT_TASK_PROGRESS_V5_DENY\n"
ERROR_TEXT = "SUBJECT_TASK_PROGRESS_V5_ERROR\n"
...
def start(
    ...
    *,
    ...
    with mission.legacy.v1._authorization_lock(
        os.fspath(repo_root), "subject-progress-v5", manifest["baseline_id"], lock
    ):
        try:
