...
DEFAULT_POLICIES: dict[str, dict[str, Any]] = {
    "conservative": {
        ...
        "auto_close_low_risk_dream_noise": False,
        "auto_close_dream_noise_memory_types": ["dream_suggestion", "consolidation_suggestion"],
        "auto_close_dream_noise_tags": ["metadata", "dedup"],
        "auto_close_dream_noise_scopes": ["project", "shared", "public"],
        "auto_close_dream_noise_sensitivities": ["low"],
