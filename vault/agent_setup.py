    ...
    *,
    ...
    def adapter_markdown(title: str, *, target: str, note: str, openclaw: bool = False) -> str:
        lines = [
            ...
            "4. Run MCP doctor when status freshness or runtime updates are unclear.",
            "5. Search only when the task needs more context.",
            "6. Use bounded reads before citing memory.",
            "7. Propose durable lessons as candidates; do not auto-promote them.",
            "",
            "MCP server:",
            "",
            "```bash",
    ...
    readme_path.write_text(
        "\n".join(
            [
                ...
                "4. Use MCP doctor when checking whether every local runtime has the fresh shared notice.",
                "5. Search only when the task or handoff needs more detail.",
                "6. Read bounded evidence before citing memory.",
                "7. Propose new durable memory as candidates.",
                "",
                "Safety boundary:",
                "",
                "- no auto-upgrade",
