...
trust: 1.0
updated_at: '2026-04-17T02:57:23.685162+00:00'
---
...
- 人際關係（誰是誰）
- **隨口小事實 → Holographic**（自動存，memory/fact_store 工具）
- **完整修復/決策 → Guardrails**（鐵律：做完就寫 raw/）
- **Holographic 發現矛盾 → 通知 Guardrails 升級為正式知識**
